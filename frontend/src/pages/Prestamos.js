                  ...
                  <td style={{ ...tdStyle, textAlign: 'center' }} onClick={e => e.stopPropagation()}>
                    {p.soporte_url ? (
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}>
                        ...
                        <a href={`/api/prestamos/soporte/${p.soporte_url}`} target='_blank' rel='noreferrer'
                      ...
                      <label style={{ cursor: 'pointer' }}>
                        <input type='file' accept='.pdf,.jpg,.jpeg' onChange={e => subirSoportePrestamo(p.id, e.target.files[0])}
                          style={{ display: 'none' }} />
                        <span style={{ color: 'var(--t-accent)', fontSize: 12, textDecoration: 'underline', cursor: 'pointer' }}>
                          + Soporte
                        </span>
                      </label>
                    )}
